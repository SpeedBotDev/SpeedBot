/*  This project is based on a Discord bot that goes under the alias "GoogieBot" which is made by Googie2149 @ Github
    Rewritten by MrGentle and Buffet Time.
*/
...
namespace SpeedBot
{
    class Program
    {
        ...
        private const string AppName = "SpeedBot"; // Name of the bot.
        ...
        private void Start(string[] args)
        {
            ...
            _client = new DiscordClient(x =>            //Create the DiscordCom Client.
            {
                x.AppName = AppName;
            ...
            {
                await _client.Connect("MjAyMTY2ODY5NTE4NTgxNzYw.CmaslA.xaFrR2y1buQhPahzI0tvK5VJxDU"); // Bot Token ID
        ...
        {
            if (u.Id == 136494200391729152) // Replace this with your own UserId (You get this by writing "\@[your own name]" in any discord chat)
